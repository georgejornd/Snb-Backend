    ...
    <div class="color-break"></div>
      ...
      <?
        ...
        if (isset($sign_up_btn)) 
        {
            ...
            {
              $errors[] = 'You have not entered your wallet';
            }
        ...
        <div class="container sign-up">
            ...
            <div class="sign-up-container">
                ...
                <form action="signup.php" method="post">
                    ...
                    <div class="sign-up-title">Check in</div>

                    <div class="sign-up-uptext">Enter your full name</div>

                    <input type="text" name="sign_up_FIO" class="sign-up-input">

                    <div class="sign-up-uptext">Enter your email</div>

                    <input type="email" name="sign_up_email" class="sign-up-input">

                    <div class="sign-up-uptext">Enter your wallet (European sample, Iban or Swift)</div>

                    <input type="" name="sign_up_wallet" class="sign-up-input">

                    <div class="sign-up-uptext">Create a password</div>

                    <input type="password" name="sign_up_password" class="sign-up-input">

                    <button class="sign-up-btn" name='sign_up_btn'>Done</button>

                    <div class="sign-up-uptext sign-up-left">Already have an account? <a href="signin.php" class="sign-up-msg-link">Entrance</a></div>
                    ...
                    <? 
                        ...
                        if (isset($_SESSION['user'])) 
                        {
                           echo('<div class="sign-up-msg">You are registered, <a class="sign-up-msg sign-up-msg-link" href="user.php">enter your profile</a></div>');
                        }
