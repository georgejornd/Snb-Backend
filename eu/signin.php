        ...
        <div class="container sign-up">
            ...
            <div class="sign-up-container">
                ...
                <form action="signin.php" method="post">
                    ...
                    <div class="sign-up-uptext">Enter your password</div>

                    <input type="password" name="sign_in_password" class="sign-up-input">

                    <button class="sign-up-btn" name='sign_in_btn'>Done</button>

                    <div class="sign-up-uptext sign-up-left">Don't have an account? <a href="signup.php" class="sign-up-msg-link">Check in</a></div>
                    ...
                    <? 
                        ...
                        if (isset($_SESSION['user'])) 
                        {
                           echo('<div class="sign-up-msg">You are logged in, <a class="sign-up-msg sign-up-msg-link" href="user.php">enter your profile</a></div>');
                        }
