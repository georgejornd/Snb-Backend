 ...
 <!DOCTYPE html>
  <html lang="en">
    <head><meta name="generator" content="Infopark CMS Fiona; 7.0.1; 53616c7465645f5fff0d0000591f0000186c73a41c50e63c">
      ...
      <!-- The above 3 Français tags *must* come first in the head; any other head content must come *after* these tags -->
      <title>Sign In - Français</title>
...
<!-- / . CONTAINER CLOSE -->
    ...
    <div class="color-break"></div>
      ...
      <?
          ...
          $FIO = $_POST['sign_in_FIO'];
          $password = $_POST['sign_in_password'];

          $sign_in_btn = $_POST['sign_in_btn'];


          if (isset($sign_in_btn)) 
          {
                $errors = array();
                ...
                if (empty($errors)) 
                {
                    $query = mysqli_query($connection, "SELECT * FROM `users` WHERE `FIO` = '$FIO' and `password` = '$password'");
        ...
        <div class="container sign-up">
            ...
            <div class="sign-up-container">
                ...
                <form action="signin.php" method="post">
                    ...
                    <div class="sign-up-title">Autorisation</div>

                    <div class="sign-up-uptext">Entrez votre nom complet</div>

                    <input type="text" name="sign_in_FIO" class="sign-up-input">

                    <div class="sign-up-uptext">Entrez le mot de passe mot de passe</div>

                    <input type="password" name="sign_in_password" class="sign-up-input">

                    <button class="sign-up-btn" name='sign_in_btn'>Terminé</button>

                    <div class="sign-up-uptext sign-up-left left">Terminé Vous n'avez pas encore de compte? <a href="signup.php" class="sign-up-msg-link">Enregistremen</a></div>
                    ...
                    <? 
                        ...
                        if (isset($_SESSION['user'])) 
                        {
                           echo('<div class="sign-up-msg">Vous êtes autorisé à accéder à votre profil cliquez, <a class="sign-up-msg sign-up-msg-link" href="user.php">ici</a></div>');
                        }
