...
<!-- / . CONTAINER CLOSE -->
    ...
    <div class="color-break"></div>
      ...
      <?
        ...
        $FIO = $_POST['sign_up_FIO'];
        $wallet = $_POST['sign_up_wallet'];
        $email = $_POST['sign_up_email'];
        $password = $_POST['sign_up_password'];

        $sign_up_btn = $_POST['sign_up_btn'];

        if (isset($sign_up_btn)) 
        {
            ...
            if ($data['sign_up_FIO'] == '') 
            {
              $errors[] = "Vous n'avez pas entré votre nom complet";
            }

            if ($data['sign_up_email'] == '') 
            {
              $errors[] = "Vous n'avez pas saisi votre email";
            }

            if ($data['sign_up_wallet'] == '') 
            {
              $errors[] = "Vous n'avez pas entré votre portefeuille";
            }

            if ($data['sign_up_password'] == '') 
            {
            ...
            if (empty($errors)) 
            {
                ...
                $query = "INSERT INTO users (`FIO`, `wallet`, `email`, `password`) VALUES ('$FIO', '$wallet', '$email', '$password')";
            ...
            if ($result) 
                {
                    $query_auth = mysqli_query($connection, "SELECT * FROM `users` WHERE `FIO` = '$FIO' and `password` = '$password'");

                    $user = mysqli_fetch_assoc($query_auth);
        ...
        <div class="container sign-up">
            ...
            <div class="sign-up-container">
                ...
                <form action="signup.php" method="post">
                    ...
                    <div class="sign-up-title">Enregistrement</div>

                    <div class="sign-up-uptext">Entrez votre nom complet</div>

                    <input type="text" name="sign_up_FIO" class="sign-up-input">

                    <div class="sign-up-uptext">Entrer votre Email</div>

                    <input type="email" name="sign_up_email" class="sign-up-input">

                    <div class="sign-up-uptext">Entrez votre portefeuille (échantillon européen, Iban ou Swift)</div>

                    <input type="" name="sign_up_wallet" class="sign-up-input">

                    <div class="sign-up-uptext">Créer un mot de passe</div>

                    <input type="password" name="sign_up_password" class="sign-up-input">

                    <button class="sign-up-btn" name='sign_up_btn'>Terminé</button>

                    <div class="sign-up-uptext sign-up-left">Vous avez déjà un compte? <a href="signin.php" class="sign-up-msg-link">Entrée.</a></div>
                    ...
                    <? 
                        ...
                        if (isset($_SESSION['user'])) 
                        {
                           echo('<div class="sign-up-msg">Vous êtes inscrit pour accéder à votre profil cliquez, <a class="sign-up-msg sign-up-msg-link" href="user.php">ici</a></div>');
                        }
