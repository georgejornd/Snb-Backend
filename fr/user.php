 ...
 <!DOCTYPE html>
  <html lang="en">
    <head><meta name="generator" content="Infopark CMS Fiona; 7.0.1; 53616c7465645f5fff0d0000591f0000186c73a41c50e63c">
      ...
      <title><? echo($user['FIO']); ?> - Français</title>
    ...
    <div class="color-break"></div>
      ...
      <?
        ...
        if (isset($create_btn)) 
        {
            ...
            if ($data['create_sum'] == '') 
            {
              $errors[] = "Vous n'avez pas saisi le montant";
            }

            if ($data['create_wallet'] == '') 
            {
              $errors[] = "Vous n'avez pas sélectionné de portefeuille";
            }

            if ($data['create_requisites'] == '') 
            {
              $errors[] = "Vous n'avez pas saisi les détails";
            }
      ...
      <script type="text/javascript">
        ...
        <div class="container sign-up">
            ...
            <div class="sign-up-container">
                ...
                <div class="user-downtext">Votre wallet - <? echo($wallet); ?></div>

                <div class="user-line"></div>

                <div class="user-date"><?= date("F j, Y, H:i", strtotime($date));; ?></div>

                <a href="logout.php"><button class="user-btn">Se déconnecte</button></a>

            </div>

             <div class="sign-up-container left user-faq">
            ...
            <a href="javascript:void(0);" onclick="user_create()"><button class="user-btn user-btn-create">Créer une demande d'échange</button></a>
            ...
            <div class="sign-up-container">
                ...
                <form action="user.php" method="post">
                    ...
                    <div class="sign-up-title">Créer une commande</div>

                    <div class="sign-up-uptext">Entrez votre nom complet</div>

                    <input type="" name="create_FIO" class="sign-up-input">

                    <div class="sign-up-uptext">Entrez le montant</div>

                    <input type="" name="create_sum" class="sign-up-input">

                    <div class="sign-up-uptext">Choisissez un portefeuille</div>
                    ...
                    <div class="sign-up-uptext">Entrez vos coordonnées</div>

                    <input type="" name="create_requisites" class="sign-up-input">

                    <button class="sign-up-btn" name='create_btn'>Terminé</button>
